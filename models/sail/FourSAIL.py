...
def foursailcore (rho, tau, lidfa, lidfb, lidftype, lai, hotspot,
    tts, tto, psi, rsoil):
    """
    Parameters
    ----------
...
def run4sail(refl, trans, rsoil0, lai, lidfa, hspot, tts, tto, psi,
    ...
    Returns
    --------
    Directional surface reflectance between 350 and 2500 nm
    ...
    [tss, too, tsstoo, rdd, tdd, rsd, tsd, rdo, tdo,
         ...
         gammasdf, gammasdb, gammaso] = foursailcore(refl, trans,
